# LCD Flashlight
Simple script that shows a white PNG on the screen that acts a fairly bright flashlight.

## How to set up:
1. Copy the 'flashlight.ds' and 'flashlight.png' files to the root of your SD card.
